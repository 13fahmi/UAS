                                ...
                                <div id="page-report-body" class="table-responsive">
                                    <table class="table  table-striped table-sm text-left">
                                        ...
                                        <tbody class="page-data" id="page-data-<?php echo $page_element_id; ?>">
                                            ...
                                            $rec_id = (!empty($data['id_pelanggan']) ? urlencode($data['id_pelanggan']) : null);
                                            $counter++;
                                            ?>
                                            <tr>
                                                <?php if($can_delete){ ?>
                                                <th class=" td-checkbox">
                                                    <label class="custom-control custom-checkbox custom-control-inline">
                                                        <input class="optioncheck custom-control-input" name="optioncheck[]" value="<?php echo $data['id_pelanggan'] ?>" type="checkbox" />
                                                            <span class="custom-control-label"></span>
                                                        </label>
                                                    </th>
                                                    <?php } ?>
                                                    <th class="td-sno"><?php echo $counter; ?></th>
                                                    <td class="td-id_pelanggan"><a href="<?php print_link("pelanggan/view/$data[id_pelanggan]") ?>"><?php echo $data['id_pelanggan']; ?></a></td>
                                                    <td class="td-nama_pelanggan">
                                                        <span <?php if($can_edit){ ?> data-value="<?php echo $data['nama_pelanggan']; ?>" 
                                                            data-pk="<?php echo $data['id_pelanggan'] ?>" 
                                                            data-url="<?php print_link("pelanggan/editfield/" . urlencode($data['id_pelanggan'])); ?>" 
