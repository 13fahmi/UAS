            ...
            <div class="row ">
                <div class="col-md-7 comp-grid">
                    ...
                    <div  class="bg-light p-3 animated fadeIn page-content">
                        <form id="transaksi_detail-add-form"  novalidate role="form" enctype="multipart/form-data" class="form multi-form page-form" action="<?php print_link("transaksi_detail/add?csrf_token=$csrf_token") ?>" method="post" >
                            <div>
                                        ...
                                        <tr class="input-row">
                                            <td>
                                                <div id="ctrl-id_barang-row<?php echo $row; ?>-holder" class="">
                                                    <select required=""  id="ctrl-id_barang-row<?php echo $row; ?>" name="row<?php echo $row ?>[id_barang]"  placeholder="Select a value ..."    class="custom-select" >
                                            ...
                                            <td>
                                                <div id="ctrl-jumlah-row<?php echo $row; ?>-holder" class="">
                                                    <input id="ctrl-jumlah-row<?php echo $row; ?>"  value="<?php  echo $this->set_field_value('jumlah',"", $row); ?>" type="number" placeholder="Enter Jumlah" step="1"  required="" name="row<?php echo $row ?>[jumlah]"  class="form-control " />
                                                    </div>
                                                </td>
