                        ...
                        <div id="page-report-body" class="">
                            <table class="table table-hover table-borderless table-striped">
                                ...
                                <tbody class="page-data" id="page-data-<?php echo $page_element_id; ?>">
                                    <tr  class="td-id_transakasi">
                                        <th class="title"> Id Transakasi: </th>
                                        <td class="value"> <?php echo $data['id_transakasi']; ?></td>
                                    </tr>
                            ...
                            <div class="dropup export-btn-holder mx-1">
                                ...
                                <div class="dropdown-menu" aria-labelledby="dropdownMenuButton">
                                    ...
                                    <div class="col-sm-12 comp-grid">
                                        <div class=" ">
                                            <?php  
                                            $this->render_page("transaksi_detail/list/transaksi_detail.id_transaksi/$data[id_transakasi]?limit_count=20" , array( 'show_header' => false,'show_footer' => false )); 
                                            ?>
                                        </div>
                                    </div>
                                </div>
