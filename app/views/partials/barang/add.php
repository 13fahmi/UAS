                            ...
                            <div>
                                <div class="form-group ">
                                    ...
                                    <div class="form-group ">
                                        <div class="row">
                                            <div class="col-sm-4">
                                                <label class="control-label" for="harga_brang">Harga Brang <span class="text-danger">*</span></label>
                                            </div>
                                            <div class="col-sm-8">
                                                <div class="">
                                                    <input id="ctrl-harga_brang"  value="<?php  echo $this->set_field_value('harga_brang',""); ?>" type="text" placeholder="Enter Harga Brang"  required="" name="harga_brang"  class="form-control " />
                                                    </div>
                                                </div>
                                            </div>
                                        </div>
